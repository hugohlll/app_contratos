...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-iq2+m7dvw%9nzk=(&t&m%fq2b&c#!2$tn-t4$@r2ze5-cu9o&n')
...
STATIC_URL = 'static/'
# Diretório onde o collectstatic irá colocar os ficheiros para o Nginx
